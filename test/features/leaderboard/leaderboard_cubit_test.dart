...
import 'package:tetris_flutter/features/leaderboard/domain/state/leaderboard_cubit.dart';
import 'package:tetris_flutter/features/leaderboard/domain/state/leaderboard_state.dart';

import 'leaderboard_cubit_test.mocks.dart';

/// Фейковые данные для тестирования
final List<LeaderboardEntity> _fakeLeaderboard = [
  const LeaderboardEntity(id: 1, username: 'User1', score: 100),
  const LeaderboardEntity(id: 2, username: 'User2', score: 200),
  const LeaderboardEntity(id: 3, username: 'User3', score: 300),
];
